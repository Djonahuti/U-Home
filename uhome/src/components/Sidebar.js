...
function Sidebar({ currentPage, setCurrentPage, isSidebarVisible }) {
  return (
    <div id="layoutSidenav_nav" className={`sb-sidenav ${isSidebarVisible ? "show" : "hide"}`}>
      <nav className="sb-sidenav accordion" id="sidenavAccordion">
        <div className="text-center">
          ...
          <span className="pow">
            <a href="https://www.uhome.com.ng">WEB DEVELOPER</a>
            <small className="dav-fs"> from Nigeria</small>
          </span>
        </div>
